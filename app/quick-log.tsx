...
// expo-file-system v19 (Expo SDK 54) ships a new typed File API by default.
// The legacy directory-and-string helpers we use here (documentDirectory,
// copyAsync, readAsStringAsync, EncodingType) now live under /legacy.
